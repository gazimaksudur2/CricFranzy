    ...
    return (
        <div className="w-full my-10">
            <div className="Running-info w-[95%] bg-green-400 mx-auto text-center">
                <h2 className="text-3xl font-semibold">Previous : </h2>
            ...
            <div className="relative h-full w-full">
                <div className="h-full w-full rounded-3xl bg-gradient-to-r from-purple-300 to-blue-300 flex items-center">
                    <div className="w-3/4 text-center md:w-2/4">
                        <img src="https://i.ibb.co/fpYvVfq/cse-removebg-preview.png" alt="" />
                    </div>
                    ...
                    <div className="w-3/4 text-center md:w-2/4">
                        <img src="https://i.ibb.co/021s0cy/swe-removebg-preview.png" alt="" />
                    </div>
                </div>
            </div>
        </div>
